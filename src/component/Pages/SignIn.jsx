...
<div className="flex justify-center items-center font-sans text-#333 h-full min-h-[90vh] p-4"
      ...
      <div className="max-w-md w-full mx-auto">
        <form onSubmit={handleSubmit} className="bg-opacity-70 bg-white rounded-2xl p-6 shadow-[0_2px_16px_-3px_rgba(6,81,237,0.3)]">
          <div className="mb-10">
          ...
          <div className="mt-10">
           <input type="submit" value="Sign up" className="w-full py-2.5 px-4 text-sm font-semibold rounded-full text-white bg-[#333] hover:bg-[#222] focus:outline-none" />
